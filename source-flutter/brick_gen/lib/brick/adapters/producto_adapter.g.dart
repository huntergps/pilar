...
Future<Producto> _$ProductoFromSupabase(
  ...
  return Producto(
    ...
    precioVenta: data['precio_venta'] == null ? null : (data['precio_venta'] as num).toDouble(),
    precioCosto: data['precio_costo'] == null ? null : (data['precio_costo'] as num).toDouble(),
    descripcion: data['descripcion'] == null ? null : data['descripcion'] as String?,
    codigoPrincipalBarras: data['codigo_principal_barras'] == null ? null : data['codigo_principal_barras'] as String?,
    unidadMedidaId: data['unidad_medida_id'] == null ? null : data['unidad_medida_id'] as String?,
    familiaId: data['familia_id'] == null ? null : data['familia_id'] as String?,
...
Future<Producto> _$ProductoFromSqlite(
  ...
  return Producto(
    ...
    nombre: data['nombre'] as String,
    tipo: data['tipo'] as String,
    precioVenta: data['precio_venta'] == null ? null : data['precio_venta'] as double?,
    precioCosto: data['precio_costo'] == null ? null : data['precio_costo'] as double?,
    descripcion: data['descripcion'] == null ? null : data['descripcion'] as String?,
    codigoPrincipalBarras: data['codigo_principal_barras'] == null ? null : data['codigo_principal_barras'] as String?,
...
class ProductoAdapter extends OfflineFirstWithSupabaseAdapter<Producto> {
  ...
  final fieldsToSupabaseColumns = {
    ...
    'codigo': const RuntimeSupabaseColumnDefinition(association: false, columnName: 'codigo'),
    'nombre': const RuntimeSupabaseColumnDefinition(association: false, columnName: 'nombre'),
    'tipo': const RuntimeSupabaseColumnDefinition(association: false, columnName: 'tipo'),
    'precioVenta': const RuntimeSupabaseColumnDefinition(association: false, columnName: 'precio_venta'),
    'precioCosto': const RuntimeSupabaseColumnDefinition(association: false, columnName: 'precio_costo'),
    'descripcion': const RuntimeSupabaseColumnDefinition(association: false, columnName: 'descripcion'),
    'codigoPrincipalBarras': const RuntimeSupabaseColumnDefinition(association: false, columnName: 'codigo_principal_barras'),
    'unidadMedidaId': const RuntimeSupabaseColumnDefinition(association: false, columnName: 'unidad_medida_id'),
    'familiaId': const RuntimeSupabaseColumnDefinition(association: false, columnName: 'familia_id'),
  ...
  final Map<String, RuntimeSqliteColumnDefinition> fieldsToSqliteColumns = {
    ...
    'codigo': const RuntimeSqliteColumnDefinition(
      association: false, columnName: 'codigo', iterable: false, type: String,
    ),
    ...
    'tipo': const RuntimeSqliteColumnDefinition(
      association: false, columnName: 'tipo', iterable: false, type: String,
    ),
    'precioVenta': const RuntimeSqliteColumnDefinition(
      association: false, columnName: 'precio_venta', iterable: false, type: double,
    ),
    'precioCosto': const RuntimeSqliteColumnDefinition(
      association: false, columnName: 'precio_costo', iterable: false, type: double,
    ),
    ...
    'codigoPrincipalBarras': const RuntimeSqliteColumnDefinition(
      association: false, columnName: 'codigo_principal_barras', iterable: false, type: String,
    ),
  ...
  }) async => await _$ProductoFromSupabase(input, provider: provider, repository: repository);
  @override
  Future<Map<String, dynamic>> toSupabase(
    Producto input, {
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$ProductoToSupabase(input, provider: provider, repository: repository);
  @override
  Future<Producto> fromSqlite(
    Map<String, dynamic> input, {
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$ProductoFromSqlite(input, provider: provider, repository: repository);
  @override
  Future<Map<String, dynamic>> toSqlite(
    Producto input, {
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$ProductoToSqlite(input, provider: provider, repository: repository);
}
